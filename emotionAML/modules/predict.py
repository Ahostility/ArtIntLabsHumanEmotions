...
from emotionAML.modules.model import MLP
from emotionAML.modules.dataset import AudioLoader

from emotionAML.dirs import DIR_DATA_MODELS

def predict(file_path, duration=4):#views
    model = MLP()
