from catalyst.dl import MeterMetricsCallback as CatalystMeterMetricsCallback,\
                        AUCCallback as CatalystAUCCallback,\
                        PrecisionRecallF1ScoreCallback as CatalystPrecisionRecallF1ScoreCallback,\
                        AccuracyCallback, ConfusionMatrixCallback
...
class AUCCallback(MeterMetricsCallback, CatalystAUCCallback): pass

class PrecisionRecallF1ScoreCallback(MeterMetricsCallback, CatalystPrecisionRecallF1ScoreCallback): pass
